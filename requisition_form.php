...
<head>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="amount1" value="" name="amount1" required readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="quantity2"  name="quantity2">
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="amount2" readonly name="amount2">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="quantity3" name="quantity3">
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="amount3" readonly name="amount3">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="quantity4" name="quantity4">
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="amount4" readonly name="amount4">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="quantity5" name="quantity5">
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="amount5" readonly name="amount5">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script src="resources/js/requisition_cal.js"></script>
