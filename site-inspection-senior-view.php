                ...
                <div id="section-2" class="row">   
                    <div class="container-fluid">
                        <div class="col-12">
                            <section id="sec-1">
                                <form action="#">
                                    <div class="text-center">
                                        ...
                                        <h5>
                                            <b>NORTHERN ENGINEERING WORKS LIMITED</b>
                                        </h5>
                                        <h6>
                                            HEALTH, SAFETY & ENVIRONMENT SITE INSPECTION CHECKLIST PREVIEW
                                        </h6>
                                        ...
                                        <div class="row d-flex flex-wrap justify-content-center mb-4 card-background-color align-items-center inputs-style">
                                            <div class="col-12 col-md-6 mb-3 mt-4">
                                                <div class="form-group">
                                                    <label class="px-0" for="sitename"></label>
                                                    <input type="text" class="form-control" id="sitename" name="sitename" 
                                                        value="Site Name: <?php echo show('site_name', $id, $connection); ?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-6 mb-3 mt-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="siteid" name="siteid" 
                                                        value="Site ID: <?php echo show('site_id', $id, $connection); ?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-6 mb-3 mt-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="region" name="region" 
                                                        value="Region: <?php echo show('region', $id, $connection); ?>" readonly>
                                                </div>
                                            </div>

                                            <div class="col-12 col-md-6 mb-3 mt-4">
                                                <div class="form-group">
                                                    <label for="inspectordate"></label>
                                                    <input type="text" class="form-control" id="inspectordate" name="inspectordate" 
                                                        value="Inspector Date: <?php echo show('inspection_date', $id, $connection); ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                            <div class="question" style="width: 100%;">
                                                ...
                                                <select  disabled name="response1" id="response1" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response1', 'commentAction1', 'descriptionAction1')">
                                            ...
                                            <div class="action" id="commentAction1" style="display: none; width: 100%; margin-top: 20px;">
                                                ...
                                                <textarea readonly name="actiontextarea1" id="actiontextarea1"><?php echo show('comment1', $id, $connection); ?></textarea>
                                            </div>
                                            ...
                                            <div id="descriptionAction1" style="width: 100%; display: none; margin-top: 20px;">
                                                ...
                                                <textarea readonly name="descriptiontextarea1" id="descriptiontextarea1"><?php echo show('action1', $id, $connection); ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-container mt-4" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                            <div class="question" style="width: 100%;">
                                                ...
                                                <select disabled name="response2" id="response2" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response2', 'commentAction2', 'descriptionAction2')">
                                                    <option value="" default>Choose</option>
                                            ...
                                            <div class="action" id="commentAction2" style="display: none; width: 100%; margin-top: 20px;">
                                                ...
                                                <textarea readonly name="actiontextarea2" id="actiontextarea2"><?php echo show('comment2', $id, $connection); ?></textarea>
                                            </div>
                                            ...
                                            <div id="descriptionAction2" style="width: 100%; display: none; margin-top: 20px;">
                                                ...
                                                <textarea readonly name="descriptiontextarea2" id="descriptiontextarea2"><?php  echo show('action2', $id, $connection);?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-container mt-4" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                            <div class="question" style="width: 100%;">
                                                ...
                                                <select disabled name="response3" id="response3" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response3', 'commentAction3', 'descriptionAction3')">
                                                    <option value="" default>Choose</option>
                                            ...
                                            <div class="action" id="commentAction3" style="display: none; width: 100%; margin-top: 20px;">
                                                ...
                                                <textarea readonly name="actiontextarea3" id="actiontextarea3"><?php echo show('comment3', $id, $connection);?></textarea>
                                            </div>
                                            ...
                                            <div id="descriptionAction3" style="width: 100%; display: none; margin-top: 20px;">
                                                ...
                                                <textarea readonly name="descriptiontextarea3" id="descriptiontextarea3"><?php echo show('action3', $id, $connection);?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-container mt-4" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                            <div class="question" style="width: 100%;">
                                                ...
                                                <select disabled name="response4" id="response4" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response4', 'commentAction4', 'descriptionAction4')">
                                                    <option value="" default>Choose</option>
                                            ...
                                            <div class="action" id="commentAction4" style="display: none; width: 100%; margin-top: 20px;">
                                                ...
                                                <textarea readonly name="actiontextarea4" id="actiontextarea4"><?php echo show('comment4', $id, $connection); ?></textarea>
                                            </div>
                                            ...
                                            <div id="descriptionAction4" style="width: 100%; display: none; margin-top: 20px;">
                                                ...
                                                <textarea readonly name="descriptiontextarea4" id="descriptiontextarea4"><?php  echo show('action4', $id, $connection);?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-container mt-4" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                            <div class="question" style="width: 100%;">
                                                ...
                                                <select disabled name="response6" id="response6" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response6', 'commentAction6', 'descriptionAction6')">
                                                    <option value="" default>Choose</option>
                            ...
                            <section id="sec-2" class="row"  style="display:none;">
                                <div class="container-fluid">
                                    <form action="#">
                                        <div class="text-center">
                                            <div class="logo mt-2 mb-3">
                                        ...
                                        <h4>2. Tower Safety Structure</h4>
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                    ...
                                                    <select disabled name="response7" id="response7" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response7', 'commentAction7', 'descriptionAction7')">
                                                        <option value="" default>Choose</option>
                                                ...
                                                <div class="action" id="commentAction7" style="display: none; width: 100%; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="actiontextarea7" id="actiontextarea7"><?php echo show('comment7', $id, $connection); ?></textarea>
                                                </div>
                                                ...
                                                <div id="descriptionAction7" style="width: 100%; display: none; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="descriptiontextarea7" id="descriptiontextarea7"><?php echo show('action7', $id, $connection);?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                    ...
                                                    <select disabled name="response8" id="response8" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response8', 'commentAction8', 'descriptionAction8')">
                                                        <option value="" default>Choose</option>
                                                ...
                                                <div class="action" id="commentAction8" style="display: none; width: 100%; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="actiontextarea8" id="actiontextarea8"><?php echo show('comment8', $id, $connection); ?></textarea>
                                                </div>
                                                ...
                                                <div id="descriptionAction8" style="width: 100%; display: none; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="descriptiontextarea8" id="descriptiontextarea8"><?php echo show('action8', $id, $connection); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                    ...
                                                    <select disabled name="response9" id="response9" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response9', 'commentAction9', 'descriptionAction9')">
                                                        <option value="" default>Choose</option>
                                                ...
                                                <div class="action" id="commentAction9" style="display: none; width: 100%; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="actiontextarea9" id="actiontextarea9"><?php echo show('comment9', $id, $connection);?></textarea>
                                                </div>
                                                ...
                                                <div id="descriptionAction9" style="width: 100%; display: none; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly  name="descriptiontextarea9" id="descriptiontextarea9"><?php echo show('action9', $id, $connection); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <section id="sec-3" class="row"  style="display:none;">
                                <div class="container-fluid">
                                    <form action="#">
                                        <div class="text-center">
                                            <div class="logo mt-2 mb-3">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                        ...
                                                        <select disabled name="response10" id="response10" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response10', 'commentAction10', 'descriptionAction10')">
                                                            <option value="" default>Choose</option>
                                                    ...
                                                    <div class="action" id="commentAction10" style="display: none; width: 100%; margin-top: 20px;">
                                                        ...
                                                        <textarea readonly name="actiontextarea10" id="actiontextarea10"><?php echo show('comment10', $id, $connection); ?></textarea>
                                                    </div>
                                                    ...
                                                    <div id="descriptionAction10" style="width: 100%; display: none; margin-top: 20px;">
                                                        ...
                                                        <textarea readonly name="descriptiontextarea10" id="descriptiontextarea10"><?php echo show('action10', $id, $connection); ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                    <div class="question" style="width: 100%;">
                                                        ...
                                                        <select disabled name="response11" id="response11" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response11', 'commentAction11', 'descriptionAction11')">
                                                            <option value="" default>Choose</option>
                                                    ...
                                                    <div class="action" id="commentAction11" style="display: none; width: 100%; margin-top: 20px;">
                                                        ...
                                                        <textarea readonly name="actiontextarea11" id="actiontextarea11"><?php echo show('comment11', $id, $connection); ?></textarea>
                                                    </div>
                                                    ...
                                                    <div id="descriptionAction11" style="width: 100%; display: none; margin-top: 20px;">
                                                        ...
                                                        <textarea readonly name="descriptiontextarea11" id="descriptiontextarea11"><?php  echo show('action11', $id, $connection);?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                    <div class="question" style="width: 100%;">
                                                        ...
                                                        <select disabled name="response12" id="response12" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response12', 'commentAction12', 'descriptionAction12')">
                                                            <option value="" default>Choose</option>
                                                    ...
                                                    <div class="action" id="commentAction12" style="display: none; width: 100%; margin-top: 20px;">
                                                        ...
                                                        <textarea readonly name="actiontextarea12" id="actiontextarea12"><?php echo show('comment12', $id, $connection); ?>
                                                        </textarea>
                                                    </div>
                                                    ...
                                                    <div id="descriptionAction12" style="width: 100%; display: none; margin-top: 20px;">
                                                        ...
                                                        <textarea readonly  name="descriptiontextarea12" id="descriptiontextarea12"><?php echo show('action12', $id, $connection); ?></textarea>
                                                    </div>
                                                    <!-- <input type="submit" class="btn btn-info mt-4" name="submit" value="Save"> -->
                                                </div>
                                        </div>
                            ...
                            <section id="sec-4" class="row"  style="display:none;">
                                <div class="container-fluid">
                                    <form action="#">
                                        <div class="text-center">
                                            <div class="logo mt-2 mb-3">
                                        ...
                                        <div class="container">
                                             ...
                                             <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                    ...
                                                    <select disabled name="response13" id="response13" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response13', 'commentAction13', 'descriptionAction13')">
                                                        <option value="" default>Choose</option>
                                                ...
                                                <div class="action" id="commentAction13" style="display: none; width: 100%; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="actiontextarea13" id="actiontextarea13"><?php echo show('comment13', $id, $connection);?></textarea>
                                                </div>
                                                ...
                                                <div id="descriptionAction13" style="width: 100%; display: none; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="descriptiontextarea13" id="descriptiontextarea13"><?php echo show('action13', $id, $connection); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                    ...
                                                    <select disabled name="response14" id="response14" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response14', 'commentAction14', 'descriptionAction14')">
                                                        <option value="" default>Choose</option>
                                                ...
                                                <div class="action" id="commentAction14" style="display: none; width: 100%; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="actiontextarea14" id="actiontextarea14"><?php  echo show('comment14', $id, $connection);?></textarea>
                                                </div>
                                                ...
                                                <div id="descriptionAction14" style="width: 100%; display: none; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="descriptiontextarea14" id="descriptiontextarea14"><?php echo show('action14', $id, $connection) ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                    ...
                                                    <select disabled name="response15" id="response15" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response15', 'commentAction15', 'descriptionAction15')">
                                                        <option value="" default>Choose</option>
                                                ...
                                                <div class="action" id="commentAction15" style="display: none; width: 100%; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="actiontextarea15" id="actiontextarea15"><?php echo show('comment15', $id, $connection); ?></textarea>
                                                </div>
                                                ...
                                                <div id="descriptionAction15" style="width: 100%; display: none; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="descriptiontextarea15" id="descriptiontextarea15"><?php echo show('action15', $id, $connection); ?></textarea>
                                                </div>
                                                <!-- <input type="submit" class="btn btn-info mt-4" name="submit" value="Save"> -->
                                            </div>
                                        </div>
                            ...
                            <section id="sec-5" class="row"  style="display:none;">
                                <div class="container-fluid">
                                    <form action="#">
                                        <div class="text-center">
                                            <div class="logo mt-2 mb-3">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                    <div class="question" style="width: 100%;">
                                                        ...
                                                        <select disabled name="response17" id="response17" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response17', 'commentAction17', 'descriptionAction17')">
                                                            <option value="" default>Choose</option>
                                                    ...
                                                    <div class="action" id="commentAction17" style="display: none; width: 100%; margin-top: 20px;">
                                                        ...
                                                        <textarea readonly name="actiontextarea17" id="actiontextarea17"><?php  echo show('comment17', $id, $connection); ?></textarea>
                                                    </div>
                                                    ...
                                                    <div id="descriptionAction17" style="width: 100%; display: none; margin-top: 20px;">
                                                        ...
                                                        <textarea readonly name="descriptiontextarea17" id="descriptiontextarea17"><?php echo show('action17', $id, $connection); ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                    <div class="question" style="width: 100%;">
                                                        ...
                                                        <select disabled name="response18" id="response18" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response18', 'commentAction18', 'descriptionAction18')">
                                                            <option value="" default>Choose</option>
                                                    ...
                                                    <div class="action" id="commentAction18" style="display: none; width: 100%; margin-top: 20px;">
                                                        ...
                                                        <textarea readonly name="actiontextarea18" id="actiontextarea18"><?php echo show('comment18', $id, $connection); ?></textarea>
                                                    </div>
                                                    ...
                                                    <div id="descriptionAction18" style="width: 100%; display: none; margin-top: 20px;">
                                                        ...
                                                        <textarea readonly name="descriptiontextarea18" id="descriptiontextarea18"><?php echo show('action18', $id, $connection); ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                    <div class="question" style="width: 100%;">
                                                        ...
                                                        <br>
                                                        <label for="response14" style="font-weight: bold; margin-top: 10px;">Response</label>
                                                        <select disabled name="response19" id="response19" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response19', 'commentAction19', 'descriptionAction19')">
                                                            <option value="" default>Choose</option>
                                                    ...
                                                    <div class="action" id="commentAction19" style="display: none; width: 100%; margin-top: 20px;">
                                                        ...
                                                        <textarea readonly name="actiontextarea19" id="actiontextarea19"><?php echo show('comment19', $id, $connection); ?></textarea>
                                                    </div>
                                                    ...
                                                    <div id="descriptionAction19" style="width: 100%; display: none; margin-top: 20px;">
                                                        ...
                                                        <textarea readonly name="descriptiontextarea19" id="descriptiontextarea19"><?php echo show('action19', $id, $connection);  ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                    <div class="question" style="width: 100%;">
                                                        ...
                                                        <select disabled name="response20" id="response20" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response20', 'commentAction20', 'descriptionAction20')">
                                                            <option value="" default>Choose</option>
                                                    ...
                                                    <div class="action" id="commentAction20" style="display: none; width: 100%; margin-top: 20px;">
                                                        ...
                                                        <textarea readonly name="actiontextarea20" id="actiontextarea20"><?php echo show('comment20', $id, $connection); ?></textarea>
                                                    </div>
                                                    ...
                                                    <div id="descriptionAction20" style="width: 100%; display: none; margin-top: 20px;">
                                                        ...
                                                        <textarea readonly name="descriptiontextarea20" id="descriptiontextarea20"><?php echo show('action20', $id, $connection); ?></textarea>
                                                    </div>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <section id="sec-6" class="row"  style="display:none;">
                                <div class="container-fluid">
                                    <form action="#">
                                        <div class="text-center">
                                            <div class="logo mt-2 mb-3">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                    ...
                                                    <select disabled name="response21" id="response21" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response21', 'commentAction21', 'descriptionAction21')">
                                                        <option value="" default>Choose</option>
                                                ...
                                                <div class="action" id="commentAction21" style="display: none; width: 100%; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="actiontextarea21" id="actiontextarea21"><?php echo show('comment21', $id , $connection); ?></textarea>
                                                </div>
                                                ...
                                                <div id="descriptionAction21" style="width: 100%; display: none; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="descriptiontextarea21" id="descriptiontextarea21"> <?php echo show('action21', $id, $connection); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                    ...
                                                    <select disabled name="response22" id="response22" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response22', 'commentAction22', 'descriptionAction22')">
                                                        <option value="" default>Choose</option>
                                                ...
                                                <div class="action" id="commentAction22" style="display: none; width: 100%; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="actiontextarea22" id="actiontextarea22"><?php  echo show('comment22', $id , $connection);?></textarea>
                                                </div>
                                                ...
                                                <div id="descriptionAction22" style="width: 100%; display: none; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="descriptiontextarea22" id="descriptiontextarea22"><?php echo show('action22', $id, $connection); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                    ...
                                                    <select disabled name="response23" id="response23" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response23', 'commentAction23', 'descriptionAction23')">
                                                        <option value="" default>Choose</option>
                                                ...
                                                <div class="action" id="commentAction23" style="display: none; width: 100%; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="actiontextarea23" id="actiontextarea23"><?php  echo show('comment23', $id, $connection);?></textarea>
                                                </div>
                                                ...
                                                <div id="descriptionAction23" style="width: 100%; display: none; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="descriptiontextarea23" id="descriptiontextarea23"><?php echo show('action23', $id, $connection); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                    ...
                                                    <select disabled name="response24" id="response24" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response24', 'commentAction24', 'descriptionAction24')">
                                                        <option value="" default>Choose</option>
                                                ...
                                                <div class="action" id="commentAction24" style="display: none; width: 100%; margin-top: 20px;">
                                                    ...
                                                    <textarea  readonly name="actiontextarea24" id="actiontextarea24"><?php echo show('comment24', $id, $connection); ?></textarea>
                                                </div>
                                                ...
                                                <div id="descriptionAction24" style="width: 100%; display: none; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="descriptiontextarea24" id="descriptiontextarea24"><?php echo show('action24', $id, $connection); ?></textarea>
                                                </div>
                                           </div>
                                        </div>
                                    </form>
                            ...
                            <section id="sec-7" class="row"  style="display:none;">
                                <div class="container-fluid">
                                    <form action="#">
                                        <div class="text-center">
                                            <div class="logo mt-2 mb-3">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                    ...
                                                    <select disabled name="response25" id="response25" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response25', 'commentAction25', 'descriptionAction25')">
                                                        <option value="" default>Choose</option>
                                                ...
                                                <div class="action" id="commentAction25" style="display: none; width: 100%; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="actiontextarea25" id="actiontextarea25"><?php  echo show('comment25', $id, $connection);?></textarea>
                                                </div>
                                                ...
                                                <div id="descriptionAction25" style="width: 100%; display: none; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="descriptiontextarea25" id="descriptiontextarea25"><?php echo  show('action25', $id, $connection); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                    ...
                                                    <select disabled name="response26" id="response26" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response26', 'commentAction26', 'descriptionAction26')">
                                                        <option value="" default>Choose</option>
                                                ...
                                                <div class="action" id="commentAction26" style="display: none; width: 100%; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="actiontextarea26" id="actiontextarea26"><?php echo show('comment26', $id, $connection); ?></textarea>
                                                </div>
                                                ...
                                                <div id="descriptionAction26" style="width: 100%; display: none; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="descriptiontextarea26" id="descriptiontextarea26"><?php echo show('action26', $id, $connection); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                    ...
                                                    <select disabled name="response27" id="response27" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response27', 'commentAction27', 'descriptionAction27')">
                                                        <option value="" default>Choose</option>
                                                ...
                                                <div class="action" id="commentAction27" style="display: none; width: 100%; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="actiontextarea27" id="actiontextarea27"><?php echo show('comment27', $id, $connection); ?></textarea>
                                                </div>
                                                ...
                                                <div id="descriptionAction27" style="width: 100%; display: none; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="descriptiontextarea27" id="descriptiontextarea27"><?php echo show('action27', $id, $connection); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                    ...
                                                    <select disabled name="response28" id="response28" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response28', 'commentAction28', 'descriptionAction28')">
                                                        <option value="" default>Choose</option>
                                                ...
                                                <div class="action" id="commentAction28" style="display: none; width: 100%; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="actiontextarea28" id="actiontextarea28"><?php echo show('comment28', $id, $connection); ?></textarea>
                                                </div>
                                                ...
                                                <div id="descriptionAction28" style="width: 100%; display: none; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="descriptiontextarea28" id="descriptiontextarea28"><?php  echo show('action28', $id, $connection);?></textarea>
                                                </div>
                                            </div>
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                    ...
                                                    <select disabled name="response29" id="response29" style="width: 50%; margin-top: 5px; padding: 5px; border-radius: 4px; border: 1px solid #ced4da;" onchange="toggleDescription('response29', 'commentAction29', 'descriptionAction29')">
                                                        <option value="" default>Choose</option>
                                                ...
                                                <div class="action" id="commentAction29" style="display: none; width: 100%; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="actiontextarea29" id="actiontextarea29"><?php echo show('comment29', $id, $connection); ?></textarea>
                                                </div>
                                                ...
                                                <div id="descriptionAction29" style="width: 100%; display: none; margin-top: 20px;">
                                                    ...
                                                    <textarea readonly name="descriptiontextarea29" id="descriptiontextarea29"><?php echo show('action29',$id, $connection); ?></textarea>
                                                </div>                                          
                                           </div>                
                                        </div>
                                    </form>
                            ...
                            <section id="sec-8" class="row"  style="display:none;">
                                <div class="container-fluid">
                                    <form action="#">
                                        <div class="text-center">
                                            <div class="logo mt-2 mb-3">
                                        ...
                                        <h4>8. Risk Assessiment / Hazards Identified  </h4>
                                            <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                    ...
                                                    <div class="action" id="controlmeasure1" style=" width: 100%; margin-top: 10px;">
                                                        ...
                                                        <textarea readonly name="controlmeasure1" id="controlmeasure1"><?php echo show('control_measure1', $id, $connection); ?></textarea>
                                                    </div>
                                                    <div id="status1" style="width: 100%; margin-top: 10px;">
                                                        <label for="status1" style="font-weight: bold;">Status</label>
                                                        <textarea readonly name="status1" id="status1"><?php echo show('status1', $id, $connection); ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="question" style="width: 100%;">
                                                        <div class="form-group" style="display: flex; align-items: center;">
                                                            <span>(b)</span>
                                                            <input readonly type="text" class="form-control" id="data-b" name="data-b" value="<?php echo show('data_b', $id, $connection); ?>" readonly style="flex: 1; margin-left: 10px;">
                                                        </div>
                                                        <br>
                                                    </div>
                                                    <div class="action" id="controlmeasure2" style=" width: 100%; margin-top: 10px;">
                                                        ...
                                                        <textarea readonly name="controlmeasure2" id="controlmeasure2"><?php echo show('control_measure2', $id, $connection); ?></textarea>
                                                    </div>
                                                    <div id="status2" style="width: 100%; margin-top: 10px;">
                                                        <label for="status2" style="font-weight: bold;">Status</label>
                                                        <textarea readonly name="status2" id="status2"><?php echo show('status2', $id, $connection); ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="flex-container" style="display: flex; gap: 20px; flex-direction: column; align-items: flex-start; background-color: #e9ecef; border-radius: 8px; padding: 20px;">
                                                <div class="question" style="width: 100%;">
                                                        <div class="form-group" style="display: flex; align-items: center;">
                                                            <span>(c)</span>
                                                            <input readonly type="text" class="form-control" id="data-c" name="data-c" value="<?php echo show('data_c', $id, $connection); ?>" readonly style="flex: 1; margin-left: 10px;">
                                                        </div>
                                                        <br>
                                                    </div>
                                                    <div class="action" id="controlmeasure3" style=" width: 100%; margin-top: 10px;">
                                                        ...
                                                        <textarea readonly name="controlmeasure3"  id="controlmeasure3"><?php echo show('control_measure3', $id, $connection); ?></textarea>
                                                    </div>
                                                    <div id="status3" style="width: 100%; margin-top: 10px;">
                                                        <label for="status3" style="font-weight: bold;">Status</label>
                                                        <textarea readonly name="status3"><?php echo show('status3', $id, $connection); ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="question" style="width: 100%;">
                                                        <div class="form-group" style="display: flex; align-items: center;">
                                                            <span>(d)</span>
                                                            <input readonly type="text" class="form-control" id="data-d" name="data-d" value="<?php echo show('data_d', $id, $connection); ?>" readonly style="flex: 1; margin-left: 10px;">
                                                        </div>
                                                        <br>
                                                    </div>
                                                    <div class="action" id="controlmeasure4" style=" width: 100%; margin-top: 10px;">
                                                        ...
                                                        <textarea readonly name="controlmeasure4" id="controlmeasure4"><?php echo show('control_measure4', $id, $connection); ?></textarea>
                                                    </div>
                                                    <div id="status4" style="width: 100%; margin-top: 10px;">
                                                        <label for="status4" style="font-weight: bold;">Status</label>
                                                        <textarea readonly name="status4" value="<?php echo $data['status4'] ?>" id="status4"><?php echo show('status4', $id, $connection); ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="question" style="width: 100%;">
                                                        <div class="form-group" style="display: flex; align-items: center;">
                                                            <span>(e)</span>
                                                            <input readonly  type="text" class="form-control" id="data-e" name="data-e" value="<?php echo show('data_e', $id, $connection); ?>" readonly style="flex: 1; margin-left: 10px;">
                                                        </div>
                                                        <br>
                                                    </div>
                                                    <div class="action" id="controlmeasure5" style=" width: 100%; margin-top: 10px;">
                                                        ...
                                                        <textarea readonly name="controlmeasure5" id="controlmeasure5"><?php echo show('control_measure5', $id, $connection); ?></textarea>
                                                    </div>
                ...
                <div id="section-3" class="row">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center mt-5" style="color:#E8ECEF;">
                            ...
                            <li class="page-item page-link-item" data-page="1"><a class="page-link" href="#" onclick="showSection(1)">1</a></li>
                            <li class="page-item page-link-item" data-page="2"><a class="page-link" href="#" onclick="showSection(2)">2</a></li>
                            <li class="page-item page-link-item" data-page="3"><a class="page-link" href="#" onclick="showSection(3)">3</a></li>
                            <li class="page-item d-none d-md-block page-link-item" data-page="4"><a class="page-link" href="#" onclick="showSection(4)">4</a></li>
    ...
    <script>
        ...
        function showSection(pageNumber) {
            ...
            for (let i = 1; i <= totalPages; i++) {
                document.getElementById('sec-' + i).style.display = (i === pageNumber) ? 'block' : 'none';
            }
            updatePagination();
        }
        ...
        function updatePagination() {
            ...
            // Manage pagination link visibility
            const pageLinks = document.querySelectorAll('.page-item:not(#prevButton):not(#nextButton)');
        ...
        // Initialize pagination visibility on page load
        document.addEventListener('DOMContentLoaded', function() {
            showSection(currentPage);
        });
